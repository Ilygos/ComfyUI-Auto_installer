...
'@
    ...
    Write-Host "                              Version 4.1 beta                                 " -ForegroundColor White
    Write-Host "-------------------------------------------------------------------------------"

    # --- Step 0: Choose Installation Type ---
    $validChoices = @("1", "2")
    Write-Host "`nChoose installation type:" -ForegroundColor Cyan
    Write-Host "1. Full (Recommended) - Installs Miniconda, Python 3.12, Git, CUDA (Isolated environment)" -ForegroundColor Green
    Write-Host "2. Light - Uses your existing Python 3.12 (Standard venv)" -ForegroundColor Yellow
